...
public class Dependencia_debil implements OrdenRealizacion {
        ...
        do {
            ...
            if(!disponibles.isEmpty()){
                for(String disp: disponibles){
                    if(!tareasEjecutables.contains(disp) && !tareasEjecutadas.contains(disp)) tareasEjecutables.add(disp);
                }
                tareasEjecutables.sort(String::compareTo);
                disponibles.clear();
            }
